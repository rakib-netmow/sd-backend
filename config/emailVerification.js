...
const emailVerifiaction = (email, otp) => {
                                            ...
                                            <div class="position-relative h-100 d-flex flex-column">
                                                <div class="mb-4">
                                                    <a href="index.html" class="d-block">
                                                        <img src="assets/img/main_logo.png" alt="" height="18">
                                                    </a>
                                                </div>
                                                <div class="mt-auto">
                                                    <div class="mb-3">
                                            ...
                                            <div class="mt-4">
                                                <form autocomplete="off">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <a href="email-verification-success.php" type="button" class="btn btn-success w-100">Confirm</a>
                                                    </div>
...
module.exports = emailVerifiaction;
